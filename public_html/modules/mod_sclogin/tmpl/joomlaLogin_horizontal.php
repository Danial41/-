        ...
        <form action="<?php echo $action; ?>" method="post" id="sclogin-form<?php echo $module->id; ?>">
            <fieldset class="userdata span12">
                <div class="control-group pull-left" id="form-sclogin-username">
                    <div class="controls">
                        <div class="input-append">
                            <input name="username" tabindex="0" <?php echo $params->get('autoFocusUsername') ? 'autofocus' : '';?> title="username" type="text" class="sclogin-username input-small"
                                   placeholder="<?php echo JText::_('MOD_SCLOGIN_USERNAME'); ?>" aria-label="<?php echo JText::_('MOD_SCLOGIN_USERNAME'); ?>" required aria-required="true">
                    ...
                    <div class="controls">
                        <div class="input-append">
                            <input id="sclogin-passwd<?php echo $module->id; ?>" name="<?php echo $passwordName; ?>" tabindex="0" title="password" type="password" class="sclogin-passwd input-small"
                                   placeholder="<?php echo JText::_('MOD_SCLOGIN_PASSWORD') ?>" aria-label="<?php echo JText::_('MOD_SCLOGIN_PASSWORD') ?>" required aria-required="true">
                ...
                <div class="control-group pull-left" id="form-sclogin-submitcreate">
                    <button type="submit" name="Submit" class="<?php echo $loginButtonClass;?>"><?php echo JText::_('MOD_SCLOGIN_LOGIN') ?></button>
                ...
                <?php if (JPluginHelper::isEnabled('system', 'remember')) :
                    ...
                    {?>
                        <div class="control-group" id="form-sclogin-remember">
                            <label for="sclogin-remember">
                                <input id="sclogin-remember" type="checkbox" name="remember" class="inputbox" <?php echo $helper->getRememberMeValue();?> title="Remember Me" />
                    ...
                    { ?>
                        <input id="sclogin-remember" type="hidden" name="remember" class="inputbox" <?php echo $helper->getRememberMeValue();?> title="Remember Me" />
                    <?php }
                endif; ?>
